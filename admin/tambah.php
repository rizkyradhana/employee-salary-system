      ...
      <tr>
        ...
        <td><input name="alamat_kar" type="text" class="form-control" id="alamat_kar" placeholder="Alamat Karyawan" required/></td>
			...
			<tr>
				...
				<td><input name="jabatan_kar" type="text" class="form-control" id="jabatan_kar" placeholder="Jabatan Karyawan" required/></td>
			</tr>
			<tr>
				<td><label for="nohp_kar">No HP Karyawan</label></td>
				<td><input name="nohp_kar" type="text" class="form-control" id="nohp_kar" placeholder="No HP Karyawan" required/></td>
			</tr>
			<tr>
        <td><label for="bank_kar">Nama Bank</label></td>
        <td><input name="bank_kar" type="text" class="form-control" id="no_rek" placeholder="Nama Bank" required/></td>
      </tr>
      <tr>
