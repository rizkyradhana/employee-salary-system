            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                 <div class="table-responsive">
                    <?php
$tampil = mysqli_query($conn, "SELECT karyawan.kary_id, karyawan.nama_kar, karyawan.bank_kar, karyawan.no_rek, karyawan.gaji_utama,
                    tb_gaji.uang_lembur, tb_gaji.total_gaji, tb_gaji.bulan_transfer, tb_gaji.tahun_transfer, tb_gaji.gaji_id FROM karyawan, tb_gaji WHERE karyawan.kary_id=tb_gaji.kary_id");
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                      ...
                      <tr>
                        ...
                        <th>Take Home Pay <i class="fa fa-sort"></i></th>
												<th>Bulan Periode <i class="fa fa-sort"></i></th>
												<th>Tahun Periode<i class="fa fa-sort"></i></th>
                    ...
                    <td>Rp.<?php echo number_format($data['total_gaji'], 2, ",", "."); ?></td>
										...
										<td><a class="btn btn-sm btn-danger" href="hapusgaji.php?hal=hapusgaji&kd=<?php echo $data['gaji_id']; ?>"><i class="fa fa-wrench"></i> Hapus Gaji</a></td></tr>
