      ...
      <div id="page-wrapper">
        ...
        <div class="col-lg-6">
            <div class="panel panel-primary">
              ...
              <h3 class="panel-title" ><i class="fa fa-user"></i> Slip Gaji Karyawan Bulan <?php //echo date("F Y");?>
								<?php
$tampil = mysqli_query($conn, "SELECT * FROM karyawan k,tb_gaji g WHERE k.kary_id=g.kary_id AND k.kary_id='$_GET[kd]'");
$total = mysqli_num_rows($tampil);
while ($data = mysqli_fetch_array($tampil)) {
    echo $data['bulan_transfer'];
    echo " ";
    echo $data['tahun_transfer'];
}
?>
              ...
              <div class="panel-body">
                 <div class="table-responsive">
                    <?php
// $tampil=mysqli_query($conn, "SELECT * FROM karyawan k,tb_gaji g WHERE k.kary_id=g.kary_id AND k.kode_kar='$_GET[kd]'");
$tampil = mysqli_query($conn, "SELECT * FROM karyawan k,tb_gaji g WHERE k.kary_id=g.kary_id AND k.kary_id='$_GET[kd]'");
$total = mysqli_num_rows($tampil);?>
